...
function performCrop() {
	...
	location.href = 'http://ohiomemory.org/digital/custom/cropimage?alias=' + alias + '&ptr=' + ptr + '&x=' + Math.round(pts.left) + '&y=' + Math.round(pts.top) + '&width=' + Math.round(pts.width) + '&height=' + Math.round(pts.height);
}