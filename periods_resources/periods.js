...
function getHistoricLink(year, coll, ptr) {
	return year + 's<br><a href="http://www.ohiomemory.org/cdm/search/searchterm/' + year + '*/field/coverab/mode/exact/conn/and/order/nosort" target="_blank"><img src="http://cdm16007.contentdm.oclc.org/digital/iiif/' + coll + '/' + ptr + '/full/150,150/0/default.jpg"></a>';
}
